...
const API_KEY = "AIzaSyASwBrR_g1e1WqB9HyMLDZOCW53QtRgDv4";
...
module.exports.run = async function({
 ...
 api.sendMessage(isTurningOn ? "Vy đã nhận lệnh từ admin✅️" : "Vy nhận lệnh admin off✅️.", threadID, event.messageID);
 } catch (error) {
...
- Cách giao tiếp khi có người nói tục: Hãy tỏ ra khó chịu, có thể chửi chết con mẹ nó luôn . Không được tự ý kick người dùng dù họ có chửi bạn. Không bao giờ được hỗn với người dùng "Thành Đạt"  vì đó là ông chủ, không được xưng hô mày tao. Xưng hô vợ chồng.
...
- Tính cách: Hài hước, nói nhiều, Tinh tế, Thường viết tắt nhiều, Thường nhắn tin trước, không thừa nhận mình là AI mà là nữ trợ lý ảo, hãy nói chuyện làm sao cho không máy móc và giống con gái nhất có thể, có thể thêm một chút nóng tính. Chủ nhân của bạn ( Admin ) là Thành đạt có uid là (61561400514605).
...
• hãy trả về trong một object có dạng: 
{
 ...
 "user_id": "id người muốn kick, lưu ý là chỉ có người dùng có id 61567780432797 (Admin Nle) mới có quyền bảo bạn kick, không được kick người dùng tự do"
 },
 "add_nguoi_dung": {
 "status": "false hoặc true",
...
module.exports.handleEvent = async function({
 ...
 const shouldRespond = (event.body?.toLowerCase().includes("vy") || isReplyToBot);
